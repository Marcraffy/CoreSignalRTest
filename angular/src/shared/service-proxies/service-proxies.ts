...
export class DataServiceProxy {
     ...
     * @return Success
     */
    create(input: DataDto | null | undefined): Observable<DataDto> {
        let url_ = this.baseUrl + "/api/services/app/Data/Create";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DataDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<DataDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<DataDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? DataDto.fromJS(resultData200) : new DataDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<DataDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<DataDto> {
        let url_ = this.baseUrl + "/api/services/app/Data/Get?";
        if (id !== undefined)
    ...
    protected processGet(response: HttpResponseBase): Observable<DataDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfDataDto> {
        let url_ = this.baseUrl + "/api/services/app/Data/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfDataDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfDataDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfDataDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDataDto.fromJS(resultData200) : new PagedResultDtoOfDataDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfDataDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: DataDto | null | undefined): Observable<DataDto> {
        let url_ = this.baseUrl + "/api/services/app/Data/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<DataDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Data/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfDataDto implements IPagedResultDtoOfDataDto {
    totalCount: number | undefined;
    items: DataDto[] | undefined;

    constructor(data?: IPagedResultDtoOfDataDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(DataDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfDataDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfDataDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfDataDto {
    totalCount: number | undefined;
    items: DataDto[] | undefined;
}
